...
class PaymentsList extends Component
{
    ...
    protected $pageName = 'payments-list';
    ...
    public function fetchData2()
    {
        ...
        foreach ($journalEntryNumbers as $journalEntryNumber) {
            ...
            foreach ($transaction as $key => $value) {
                if (ChartOfAccounts::find($value->account_number)->account_name == 'PROPERTIES AND EQUIPMENT' || ChartOfAccounts::find($value->account_number)->account_name == 'PROPERTIES AND EQUIPMENT') {
    ...
    {
        return view('livewire.transactions.payments-list');
    }
}
