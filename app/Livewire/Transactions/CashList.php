...
class CashList extends Component
{
    ...
    public function getNewBeginningBalances()
    {
        ...
        $chartOfAccount = ChartOfAccounts::all();

        foreach ($chartOfAccount as $account_number => $account) {
    ...
    {
        return view('livewire.transactions.cash-list');
    }
}
