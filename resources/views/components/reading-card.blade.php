<div
    ...
    <div class="w-full md:col-span-2 grid grid-cols-1 md:grid-cols-5 pl-4 font-bold gap-4">
        ...
        <div class="w-full md:col-span-2 flex flex-row items-end justify-end gap-2">
            {{ $buttons }}
        </div>
