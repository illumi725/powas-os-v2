<form autocomplete="off" wire:submit="saveMember">
    @csrf
    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 lg:gap-8">

        <div class="mt-1 md:mt-0">
            <x-label for="lastname" value="{{ __('Last Name') }}" />
            <x-input wire:model="lastname" id="lastname" name="lastname" type="text" class="block mt-1 w-full" autofocus
                autocomplete="off" />
        ...
        <div class="mt-1 md:mt-0">
            ...
            <x-input wire:model="firstname" id="firstname" name="firstname" type="text" class="block mt-1 w-full"
                autocomplete="off" />
        ...
        <div class="mt-1 md:mt-0">
            ...
            <x-input wire:model="middlename" id="middlename" name="middlename" type="text" class="block mt-1 w-full"
                autocomplete="off" />
        ...
        <div class="mt-1">
            ...
            <x-input wire:model="birthday" id="birthday" name="birthday" type="date" class="block mt-1 w-full"
                autocomplete="off" />
        ...
        <div class="mt-1">
            ...
            <x-input wire:model="birthplace" id="birthplace" name="birthplace" type="text" class="block mt-1 w-full"
        ...
        <div class="mt-1">
            <x-label for="membershipDate" value="{{ __('Membership Date') }}" />
            <x-input wire:model="membershipDate" id="membershipDate" name="membershipDate" type="date"
                class="block mt-1 w-full" autocomplete="off" />
            <x-input-error for="membershipDate" class="mt-1" />
        </div>
    ...
    <div class="mt-4">
        <div class="flex justify-end items-center align-bottom h-full">
            <x-alert-message class="me-3" on="message" />
            <x-button class="ms-4">
                <i class="fa-regular fa-floppy-disk" wire:loading.attr="disabled"></i></i>&nbsp;{{ __('Save') }}
            </x-button>
        </div>
    </div>
